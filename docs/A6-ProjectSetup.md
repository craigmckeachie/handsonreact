...
- Use [Create React App](https://create-react-app.dev/)
  ...
  - Because the React team's roadmap is headed in future a direction SSR that Create React App cannot support (only supports CSR) the project seems to be getting less frequent patches. [Reference](https://github.com/facebook/create-react-app/discussions/11768)
